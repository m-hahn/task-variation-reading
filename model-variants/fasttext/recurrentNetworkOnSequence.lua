...
if (DOING_EVALUATION_OUTPUT and CREATE_RECORDED_FILES) or (DOING_EVALUATION_OUTPUT and torch.uniform()>0.7)   or (neatQA.STORE_Q_ATTENTION and torch.uniform() > 0.9) then
