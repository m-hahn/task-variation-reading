    ...
    -- adapted from torch.renorm
      ...
      embeddingsForAtt:cdiv(norms:expandAs(embeddingsForAtt))
       ...
       print("Getting FastText embeddings")
        ...
        embeddingsForAtt = torch.CudaTensor(params.vocab_size+1,300)
        embeddingsForAtt:uniform(-0.1, 0.1)
        embeddingsForAttGrad = torch.CudaTensor(params.vocab_size+1,300):zero()
        readDict.setToFastTextEmbeddings(embeddingsForAtt)
...
--       embeddingsForAtt = torch.div(embeddings,embeddingsShrinkingFactor)
    ...
    if true then
     ...
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("beer")+1]*embeddingsForAtt[readDict.word2NumCached("beer")+1])
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached(".")+1]*embeddingsForAtt[readDict.word2NumCached(".")+1])
     print("beer wine")
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("beer")+1]*embeddingsForAtt[readDict.word2NumCached("wine")+1])
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("beer")+1]*embeddingsForAtt[readDict.word2NumCached("alcohol")+1])
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("beer")+1]*embeddingsForAtt[readDict.word2NumCached("brewer")+1])
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("computer")+1]*embeddingsForAtt[readDict.word2NumCached("wine")+1])
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("paper")+1]*embeddingsForAtt[readDict.word2NumCached("wine")+1])
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("drink")+1]*embeddingsForAtt[readDict.word2NumCached("wine")+1])
     --print(embeddingsForAtt[readDict.word2NumCached("towel")+1]*embeddingsForAtt[readDict.word2NumCached("paper")+1])
     print("paper article")
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("paper")+1]*embeddingsForAtt[readDict.word2NumCached("article")+1])
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("paper")+1]*embeddingsForAtt[readDict.word2NumCached("stone")+1])
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("paper")+1]*embeddingsForAtt[readDict.word2NumCached("elephant")+1])
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("paper")+1]*embeddingsForAtt[readDict.word2NumCached("bicycle")+1])
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("@entity5")+1]*embeddingsForAtt[readDict.word2NumCached("@entity7")+1])
     print(embeddingsShrinkingFactor*embeddingsShrinkingFactor*embeddingsForAtt[readDict.word2NumCached("@entity5")+1]*embeddingsForAtt[readDict.word2NumCached("@entity5")+1])
    end
