...
--  reader2 = nn.PrintLayer("reader2")(reader2)
  local lastStates = nn.SelectTable(2)(reader2)
  --lastStates = nn.PrintLayer("lastStates")(lastStates)
  ...
  local withActor = nn.LogSoftMax()(inActor)
...
--               print(readChunks.corpus[l].text)
               print("ANSW "..answerID)
               print("PROB "..neatQA.fullOutput[2][l][answerID])
